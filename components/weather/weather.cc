...
bool Weather::to_json(class UoutWriter &td) {
  td.sj().alloc_bigger_buffer(1024);
  return td.sj().read_json_arr2_from_function(std::bind(&Weather::get_past_weather_data_json, this,  _1, _2, _3, _4), 7, 24);
}
